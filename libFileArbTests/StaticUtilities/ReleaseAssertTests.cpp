...
static void FailReleaseAssertFunction()
{
   ...
   catch (const logic_error& e)
   {
      ...
      IS_TRUE(Utils::String::CaseInsensitiveContainsSubstring(what, "ReleaseAssertTests.cpp(22)"));
   }
}
...
TEST(release_assert_IsFalse_FromOperatorParentheses_ThrowsLogicError)
{
   ...
   catch (const logic_error& e)
   {
      ...
      IS_TRUE(Utils::String::ContainsSubstring(what, "release_assert(false) failed in operator ()()"));
#endif
      IS_TRUE(Utils::String::CaseInsensitiveContainsSubstring(what, "ReleaseAssertTests.cpp(40)"));
   }
}
