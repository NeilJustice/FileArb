...
TEST(DefaultConstructor_NewsYearMonthParser)
{
   ...
   STD_FUNCTION_TARGETS(DocoptParser::StaticGetRequiredString, docoptParser._call_StaticGetRequiredString);
}
...
TEST(StaticGetRequiredSizeT_ArgInMapAsNegative1_ReturnsSizeTMaxValue)
{
   ...
   //
   const size_t sizeTValue = DocoptParser::StaticGetRequiredSizeT(_docoptArgs, _argName);
   //
...
TEST(StaticGetRequiredSizeT_ArgInMapAsSizeTValue_ReturnsSizeT)
{
   ...
   //
   const size_t returnedSizeTValue = DocoptParser::StaticGetRequiredSizeT(_docoptArgs, _argName);
   //
   ARE_EQUAL(sizeTValue, returnedSizeTValue);
}
