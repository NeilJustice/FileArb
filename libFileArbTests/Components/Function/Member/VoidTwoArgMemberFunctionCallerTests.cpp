...
Utils::VoidTwoArgMemberFunctionCaller<Class, Arg1Type, Arg2Type> _voidTwoArgMemberFunctionCaller;
...
TEST(CallNonConstMemberFunctionNTimes_NIs0_CallsFunctionZeroTimes)
{
   _voidTwoArgMemberFunctionCaller.CallNonConstMemberFunctionNTimes(
      0, &Class::NonConstTwoArgMemberFunction, &_classInstance, Arg1Type{}, Arg2Type{});
...
TEST(CallNonConstMemberFunctionNTimes_NIs2_CallsFunctionTwice)
{
   ...
   //
   _voidTwoArgMemberFunctionCaller.CallNonConstMemberFunctionNTimes(
      2, &Class::NonConstTwoArgMemberFunction, &_classInstance, arg1, arg2);
   //
