...
from FileArbPyUtils import Python, Process, UnitTester, Random
...
class PythonTests(unittest.TestCase):
   ...
   @patch('FileArbPyUtils.Process.run_and_get_exit_code', spec_set=True)
   ...
   def pylint_all_LinuxCallsMapParallelPylintFileWithAllPyFilePaths_WindowsCallsMapSequential_test(self):
      ...
      @patch('FileArbPyUtils.Process.run_parallel_processpoolexecutor', spec_set=True)
      @patch('FileArbPyUtils.Process.run_parallel_processthread', spec_set=True)
