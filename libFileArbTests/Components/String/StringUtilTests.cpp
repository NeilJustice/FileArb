...
{
	ARE_EQUAL("", Utils::String::Concat(""));
	ARE_EQUAL("1", Utils::String::Concat("1"));
	ARE_EQUAL("12", Utils::String::Concat("1", "2"));
	ARE_EQUAL("123", Utils::String::Concat("1", "2", "3"));

   const UserType userType1(1);
   const string str = "hello";
   const UserType userType3(3);
	ARE_EQUAL("1hello3", Utils::String::Concat(userType1, str, userType3));
}
