...
import docopt
from FileArbPyUtils import CoverageLintInstallPythonLibrary, Python, Process, UnitTester, Random # pylint:disable=no-name-in-module
...
CoverageLintInstallPythonLibrary.__doc__)
   ...
   @patch('FileArbPyUtils.Python.flake8_all', spec_set=True)
   @patch('FileArbPyUtils.Python.pylint_all', spec_set=True)
